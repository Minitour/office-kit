...
description: Install or update an isolated OfficeKit workspace inside the current repository. Use before creating OfficeKit documents, slides, videos, brands, or narration when an office-kit directory is absent or needs an upgrade.
...
Create an isolated `office-kit/` workspace in the current repository. Do not
